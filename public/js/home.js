...
function add_comment(e, note_id, user_id) {
    ...
    $.ajax(requestConfig).then(function (responseMessage) {
        ...
        var comments = document.getElementById("comments-add");

        comments.innerHTML += '<div class="d-flex" style="background-color: #cccccc73;margin-bottom: 5px;border-radius: 11px;">' +
